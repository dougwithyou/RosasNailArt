/**
 * ROSAS NAILS ART — Language detection + static text translation
 * Detects the visitor's browser language (English vs. Spanish, default)
 * and swaps every element marked with data-i18n* to match. Free-text
 * content Maribel writes herself from the superadmin CMS is left as-is —
 * only the site's own fixed copy (nav, buttons, section headings, default
 * fallback text) is translated here; the visitor's browser can offer to
 * translate any remaining Spanish CMS text on its own.
 */
(function () {
  'use strict';
